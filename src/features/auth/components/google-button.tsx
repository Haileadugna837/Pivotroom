  ...
  return (
    ...
    >
      <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
        ...
        <path
          fill="#4CAF50"
          d="M24 44c5.5 0 10.4-2.1 14.2-5.6l-6.6-5.4C29.5 34.9 26.9 36 24 36c-5.2 0-9.6-3.3-11.3-7.9l-6.5 5C9.6 39.6 16.3 44 24 44z"
        />
        <path
          fill="#1976D2"
          d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4.1 5.6l6.6 5.4C41.9 36.4 44 30.7 44 24c0-1.3-.1-2.7-.4-3.5z"
        />
      </svg>
