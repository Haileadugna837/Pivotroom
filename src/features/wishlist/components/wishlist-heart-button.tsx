...
export function WishlistHeartButton({
  ...
  return (
    <button
      ...
      className={`flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-black shadow-sm hover:bg-white disabled:opacity-70 ${className}`}
    >
      <svg width="17" height="17" viewBox="0 0 20 20" fill={wishlisted ? "currentColor" : "none"} aria-hidden="true">
        <path
