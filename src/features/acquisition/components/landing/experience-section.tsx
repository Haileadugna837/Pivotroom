    ...
    <section className="mx-auto w-full max-w-6xl px-6 py-20">
      <div className="grid items-center gap-16 lg:grid-cols-2">
        <div className="relative mx-auto w-full max-w-sm lg:max-w-none">
          ...
          <div className="absolute top-2 right-0 w-56 sm:w-64 lg:-right-6">
            <div className="rounded-2xl rounded-br-sm border border-black/10 bg-background p-4 text-left shadow-lg dark:border-white/15">
