  ...
  return (
    <header className="flex min-h-[620px] flex-col items-center justify-center border-b border-pivot-line px-6 py-20 text-center sm:min-h-[700px] sm:py-16 md:py-24">
      <div className="mx-auto flex w-full max-w-[900px] flex-col items-center">
        ...
        <h1 className="mx-0 mt-6 mb-7 font-serif text-[46px] leading-[0.96] tracking-[-0.04em] text-pivot-ink sm:my-5 sm:text-[64px] sm:leading-[0.92] md:text-[84px] lg:text-[104px]">
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3 sm:mt-5">
        ...
        <div className="mt-4 text-[11px] text-pivot-muted sm:mt-3.5">Free to join early access. No payment required now.</div>
        <div className="mt-14 grid w-full max-w-[650px] grid-cols-1 gap-8 border-t border-pivot-ink pt-6 sm:mt-11 sm:grid-cols-3 sm:gap-5 sm:pt-5">
          {PROOFS.map((proof) => (
